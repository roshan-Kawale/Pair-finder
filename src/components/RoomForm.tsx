...
export function RoomForm({ room , onSubmit }: { room?: Room; onSubmit: (values: Room) => void; }) {
    ...
    return (
        ...
        <CardHeader>
          ...
          <CardDescription>Set up a new discussion room for your topic.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>This is the name of your discussion room.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Describe the room's topic" {...field} />
                    </FormControl>
                    <FormDescription>Provide a brief description of the room&apos;s purpose.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
                ...
                render={() => (
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="flex flex-wrap gap-2">
                        {language.map((lang) => (
                          <span key={lang} className="bg-primary text-primary-foreground px-2 py-1 rounded-full text-sm flex items-center">
                            {lang}
                            <button type="button" onClick={() => removelang(lang)} className="ml-2">
                              <X className="h-3 w-3" />
                            </button>
                          </span>
                        ))}
                    ...
                    <FormDescription>Press Enter to add a Language.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Choose the experience level for the room.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Set the maximum number of participants (2-100).</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
